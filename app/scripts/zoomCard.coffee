# Requires "paper-dialog", "paper-dialog-transition-center", and "base-card" to be imported in the element that uses this
...
zoomCard =
  zoomCard: ->
    ...
    # this guarantees that the children are laid out so the dialog can position itself correctly
